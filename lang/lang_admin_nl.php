...
$lll["db_installed"]="%s database is geïnstalleerd: %s";
// Changed in version 4.1.0. Old text:
...
$lll["inst_create_table_err"]="Foutmelding bij het aanmaken van de tabellen, %s is wellicht al geïnstalleerd?";
// Changed in version 4.1.0. Old text:
...
$lll["inst_click"]="Klik hier om %s te benaderen.";
// Changed in version 4.1.0. Old text:
//$lll["createTableFailed"]="Create table failed";
// New text:
$lll["createTableFailed"]="Ouch! Create table failed";
$lll["install"]="Installeer";
$lll["clickToInstall"]="Klik op 'Installeer' om %s te installeren!";
$lll["admin_ok"]="Admin is als gebruiker aangemaakt, gebruikersnaam: admin, wachtwoord: admin.";
// Changed in version 4.1.0. Old text:
...
$lll["inst_params"]="MySQL-database zal worden aangemaakt met de volgende waarden:";
$lll["edit_params"]="Wijzig waarden";
...
$lll["hostName"]="Hostnaam";
$lll["dbHostName"]="Hostnaam";
$lll["mysqluser"]="Mysql-gebruikersnaam";
$lll["dbName"]="Databasenaam";
$lll["dbDbName"]="Databasenaam";
$lll["dbSocket"]="Socket";
$lll["formtitle"]="MySQL-instellingen";
$lll["password"]="Wachtwoord";
$lll["dbPort"]="Poort";
$lll["cookieok"]="Cookies staan aan.";
// Changed in version 4.1.0. Old text:
...
$lll["afterwrconf"]="<u>Nadat</u> het config-bestand is gemaakt klik op de onderstaande link!";
$lll["move_inst_file"]="Verwijder het install.php-bestand uit deze map!";
// Changed in version 4.1.0. Old text:
...
$lll["create_file_nok_ext"]="De server heeft geen toestemming om het config-bestand aan te maken. Je hebt twee mogelijkheden:<br>
#1: Maak een leeg bestand in de applicatie map met de naam app/config.php en geef de server voldoende rechten om in dit bestand te schrijven. Onder Unix:<br>touch app/config.php;chmod 777 app/config.php<br>en klik op de Reload/Refresh knop.<br>#2: Klik op Installeer en maak het app/config.php-bestand handmatig aan met je teksteditor.<br>De applicatie zal u de tekst tonen die in dit bestand moet staan.";
...
$lll["ready_to_update"]="Klaar om database %s up te daten naar versie %s?<br>";
// Changed in version 4.1.0. Old text:
...
$lll["updating"]="Bezig met updaten van versie %s naar versie %s...";
// Changed in version 4.1.0. Old text:
...
$lll["nopermission_expl"]="(het systeem heeft deze schrijfrechten nodig om afbeeldingen op te kunnen slaan in de aangegeven directories)";
...
$lll["here1"]="klik hier";
$lll["confpreerr"]="Er zijn karakters vóór de &lt;? in het config-bestand! Verwijder deze karakters (ook nieuwe/lege regels en spaties)!";
$lll["confposterr"]="Er zijn karakters ná de ?&gt; in het config-bestand! Verwijder deze karakters (ook nieuwe/lege regels en spaties)!";
$lll["conffileok"]="Het config-bestand lijkt in orde te zijn.";
// Changed in version 4.1.0. Old text:
...
$lll["confcheck"]="Controleren systeemconfiguratie...";
// Changed in version 4.1.0. Old text:
...
$lll["confclicheck"]="U kunt deze pagina te allen tijde openen, door op 'Check' te klikken.";
$lll["chadmemail"]="Uw e-mailadres is nu nog 'admin@admin.admin'. Zorg ervoor dat u dit wijzigt door op 'Mijn profiel' te klikken!";
// Changed in version 4.1.0. Old text:
...
$lll["chadmpass"]="Het standaard Admin-wachtwoord is nog niet gewijzigd! Zorg ervoor dat u dit wijzigt door op 'Wijzig wachtwoord' te klikken!";
$lll["settings_adminEmail"]="Standaard e-mailadres";
// Changed in version 4.1.0. Old text:
...
$lll["nogd"]="Waarschuwing: uw server heeft de GD-bibliotheek niet geïnstalleerd.";
// Changed in version 4.1.0. Old text:
...
$lll["settings"]="Instellingen";
$lll["settings_modify_form"]="Personaliseren";
$lll["settings_expNoticeBefore"]="Aantal dagen dat de gebruiker op de hoogte gesteld moet worden vóórdat de advertentie verloopt";
$lll["settings_charLimit"]="Aantal tekens dat een advertentie mag bevatten";
$lll["settings_blockSize"]="Advertenties die per pagina worden getoond";
$lll["settings_maxPicSize"]="Maximale afbeeldingsgrootte in bytes";
$lll["settings_maxPicWidth"]="Maximale afbeeldingsbreedte in pixels";
$lll["settings_maxPicHeight"]="Maximale afbeeldingshoogte in pixels";
...
$lll["menuPointsSep"]="Menubeheer";
$lll["expirationProperties"]="Verloopinstellingen";
$lll["imageProperties"]="Bestandsbeperkingen";
$lll["otherProperties"]="Overige instellingen";
$lll["adDisplayProperties"]="Ad display settings";
$lll["settings_renewal"]="Aantal keren dat iemand een verlopen advertentie mag verlengen";
$lll["settings_allowModify"]="Gebruiker mag eigen advertenties wijzigen";
...
$lll["customfield"]="Variabele velden";
$lll["mustBeCommaSeparated"]="De mogelijke waarden voor de selectievelden moeten gescheiden worden door middel van een komma.";
$lll["invalidDefaultValue"]="De standaardwaarde van een selectieveld moet bestaan in een van de opgegeven mogelijke waarden.";
$lll["description"]="Description";
$lll["descriptionDefaultLabel"]="Omschrijving";
$lll["privateField"]="Privé";
$lll["customfield_type_1"]="Text";
$lll["customfield_type_2"]="Textarea";
$lll["customfield_type_3"]="Boolean";
$lll["customfield_type_4"]="Selection";
$lll["customfield_type_6"]="Multiple selection";
...
$lll["customfield_active"]="Actief";
$lll["customfield_separator"]="Column 1.";
$lll["customfield_mandatory"]="Verplicht";
// Changed in version 3.0.0. Old text:
//$lll["customfield_showInList"]="Appears in list";
// New text:
//$lll["customfield_showInList"]="Show in lists for";
$lll["customfield_showInList"]="Show in lists for";
$lll["customfield_values"]="Mogelijke waarden";
$lll["customfield_innewline"]="In een nieuwe regel plaatsen";
...
$lll["customfield_allowHtml"]="HTML toestaan";
...
$lll["customfield_private"]="Privé-advertentie toestaan";
...
$lll["private_field"]="(prive)";
$lll["customfield_newitem"]="Add new custom field";
$lll["customfield_modify_form"]="Geef de variabele velden voor advertenties binnen deze rubriek";
...
$lll["customfield_rowspan_expl"]="Use this in conjunction with the 'Place in new line' property of other custom fields. If there are other fields which has been placed in a new line, you can specify with this setting that this field spans over those new lines vertically.";
$lll["notification"]="notificaties";
$lll["notification_ttitle"]="Notificaties";
$lll["Notifications"]="Notificaties";
$lll["notification_subject"]="E-mailonderwerp";
$lll["notification_body"]="E-mailtekst";
$lll["notification_variables"]="Toegestande variabelen";
$lll["notification_active"]="Actief";
$lll["notification_modify_form"]="Notificaties wijzigen";
...
$lll["notification_cc_expl"]="Specificeer een e-mail-adres waar een kopie van de e-mail naar wordt verstuurd.";
$lll["notification_active_expl"]="Hier kan je de notificatie in- en uitschakelen.";
?>