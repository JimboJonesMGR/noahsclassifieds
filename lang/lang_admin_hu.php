...
// Added in 2.4.0:
$lll["settings_charLimit_expl"]="'0' azt jelenti, hogy nincs korlátozás.";
$lll["settings_extraTopContent"]="További tartalom felülre";
// Changed in version 4.1.0. Old text:
...
$lll["settings_extraBottomContent"]="További tartalom alulra";
// Changed in version 4.1.0. Old text:
...
$lll["customfield_subType_expl"]="Pl. Ha van agy 'Ár' mezője, ajánlott azt 'Tizedes szám'-ként definiálni, azért, hogy az ár szerinti rendezés a hírdetés listában megfelelően működjön. Azután megadhatja a szükséges valuta-előtagot, a tizedesjegy pontosságot és az ezreseket elválasztó jelet a 'Mezőformátum' szakaszban.";
$lll["formatSection"]="Mezőformátum";
$lll["customfield_formatPrefix"]="Előtag";
$lll["category_expirationEnabled"]="Elévülés engedélyezése";
$lll["category_expirationOverride"]="Az elévülés felüldefiniálásának engedélyezése";
$lll["category_expirationOverride_expl"]="Ha engedélyezi, az 'Az elévülésig hátralevő napok' mező meg fog jelenni a hírdetés létrehozás űrlapon és a hírdetés tulajdonosa megadhat egy számot. H a 0-t írt be a fenti mezőbe, akkor a tulajdonos egy tetszőleges elévülést megadhat a hírdetésének. Ha bármi nullánál nagyobb értéket írt be, akkor az egyrészt az alapértelmezett elévülési értéket fogja jelenteni, másrészt a maximumot is, amit a tulajdonos elévülésként megadhat.";
$lll["category_expirationOverride_0"]="Senkinek";
$lll["category_expirationOverride_2"]="Minden felhasználónak";
$lll["category_expirationOverride_4"]="Csak adminnak";
$lll["category_allowSubmitAdAdmin"]="Csak admin hozhat létre hírdetést ebben a kategóriában";
$lll["category_organize"]="Kategória rendező";
$lll["exp"]="Elévülés";
$lll["useDragAndDrop"]="Használjon 'drag-and-drop'-pot (húzza a kategóriákat az egérrel) a kategóriák átrendezésére, majd klikkeljen a 'Sorrend mentése' linkre!";
$lll["organizeSaveButton"]="Sorrend mentése";
$lll["organizeSaveMessage"]="A kategoriák sorrendjét elmentettük";
$lll["organizeSaveError"]="Hiba: az adatokat nem sikerült elküldeni a szervernek.";
$lll["organizeLoadError"]="Hiba: az adatokat nem sikerült betölteni a szerverről.";
...
$lll["securityProperties"]="Biztonsági beállítások";
$lll["settings_applyCaptcha"]="Spam-védelem (CAPTCHA) alkalmazása a következő űrlapokon";
$lll["settings_applyCaptcha_1"]="'Válasz a hírdetésre' és 'Továbbítás egy ismerősnek'";
$lll["settings_applyCaptcha_2"]="Bejelentkezés";
$lll["settings_applyCaptcha_3"]="Regisztráció";
$lll["settings_applyCaptcha_4"]="Hírdetésfeladás";
$lll["customfield_displayLabel"]="Cimke mutatása";
$lll["customfield_displayLabel_expl"]="Ha nincs kijelölve, a mező cimkéje nem fog szerepelni a hírdetés adatlapján és a mező értéke \"átnyúlik\" a többi mező cimkéjén.";
$lll["customfield_detailsPosition"]="Elhelyezkedés";
$lll["customfield_detailsPosition_expl"]="A mező elhelyezése a hírdetés adatlapján. Az oldalsó oszlop az adatlapnak az a jobb oldali része, ahol a képek is elhelyezkednek (a 'modern' dizájntémában). Ezzel a beállítással a képek fölé és alá is beilleszthetjük a mezőt.";
$lll["customfield_detailsPosition_0"]="Hagyományos";
$lll["customfield_detailsPosition_1"]="Az oldalsó oszlop teteje";
$lll["customfield_detailsPosition_2"]="Az oldalsó oszlop alja";
$lll["formProperties"]="Űrlap beállítások";
$lll["listProperties"]="Lista beállítások";
$lll["detailsProperties"]="Adatlap beállítások";
$lll["searchProperties"]="Keresési beállítások";
$lll["miscProperties"]="Egyéb beállítások";
$lll["customfield_showInDetails"]="A mező látható";
...
$lll["settings_adminEmail"]="Adminisztrátor email";
// Changed in version 4.1.0. Old text:
...
$lll["settings"]="Beállítások";
$lll["settings_modify_form"]="Személyreszabás";
$lll["settings_expNoticeBefore"]="Enny nappal a hírdetés elévülése előtt kap a tulajdonos értesítést";
$lll["settings_charLimit"]="A hírdetés mezőjének maximális karakterszáma";
$lll["settings_charLimit_expl"]="'0' = nincs korlátozás.";
$lll["settings_blockSize"]="Blokk méret (listák lapozásánál)";
$lll["settings_maxPicSize"]="Maximális képméret byte-ban";
$lll["settings_maxPicWidth"]="Maximális képszélesség";
$lll["settings_maxPicHeight"]="Maximális képmagasság";
$lll["settings_maxPicHeight_expl"]="'0' = nincs korlátozás.";
$lll["settings_maxPicWidth_expl"]="'0' = nincs korlátozás.";
$lll["settings_maxPicSize_expl"]="'0' = nincs korlátozás.";
$lll["settings_adminFromName"]="Rendszer adminisztrátor név";
$lll["settings_adminFromName_expl"]="Ez fog névként megjelenni a a program által küldött értesítések 'Küldő:' mezejében.";
$lll["settings_versionFooter"]="Lábléc";
$lll["settings_titlePrefix"]="Címmező-előtag";
$lll["settings_dateFormat"]="Dátum formátum";
$lll["settings_dateFormat_expl"]="További információt az elérhető dátumformátumokról , <a href='http://php.net/manual/hu/function.date.php' target='_blank'>itt találhat</a>";
...
$lll["settings_enableFavorities"]="Enable the 'Add to favorities' feature for";
$lll["settings_enableFavorities_expl"]="Az ingyenes verzióban nem engedélyezhető!";
$lll["settings_updateCheckInterval"]="Noah's frissítések automatikus keresése";
$lll["settings_updateCheckInterval_expl"]="A program rendszeresen ellenőrizheti neten keresztül, hogy rendelkezésre áll-e új programfrissítés, 
                                              s ha igen, megjeleníti a frissítési oldalt az admin számára. Ez a beállítás meghatározza, hogy hány naponként történjen az ellenőrzés.
                                              Ha ki akarja kapcsolni a szolgáltatást, állítsa 0-ra!";
$lll["mailProperties"]="Levélküldési beállítások";
$lll["themeProperties"]="Dizájntéma-támogatás";
$lll["settings_defaultTheme"]="Alapértelmezett dizájntéma";
$lll["settings_allowedThemes"]="Választható dizájntémák";
$lll["settings_allowedThemes_expl"]="Ha létrehoz egy új alkönyvtárat a saját dizájntémájának 'themes' alatt - pl. 'saját_témám', az automatikusan meg fog ebben a listában jelenni mint 'Saját témám'!";
$lll["settings_allowSelectTheme"]="Témaválasztás engedélyezése";
$lll["settings_allowSelectTheme_expl"]="Ha engedélyezi, egy legördülő lista jelenik meg minden oldalon, mely lehetővé teszi a dizájntéma azonnali megváltoztatását bármely felhasználó számára (a megjenés személyre szabása)";
$lll["languageProperties"]="Nyelvi támogatás";
$lll["settings_defaultLanguage"]="Alapértelmezett nyelv";
$lll["settings_allowedLanguages"]="Választható nyelvek";
$lll["settings_allowSelectLanguage"]="Nyelvválasztás engedélyezése";
$lll["settings_allowSelectLanguage_expl"]="Ha engedélyezi, egy legördülő lista jelenik meg minden oldalon, mely lehetővé teszi a felület nyelvének azonnali megváltoztatását bármely felhasználó számára.";
$lll["settings_smtpServer"]="SMTP szerver név";
$lll["settings_smtpServer_expl"]="Akkor használja ezeket a mezőket, ha a program értesítéseit egy SMTP szerveren keresztül szeretné küldeni. Máskülönben a program a Php beépített mail függvényét fogja használni.";
$lll["settings_smtpUser"]="SMTP felhasználónév";
$lll["settings_smtpPass"]="SMTP jelszó";
$lll["settings_fallBackNative"]="SMTP kúldés meghiúsulása esetén a Php beépített mail függvényével próbálkozzunk";
$lll["settings_titlePrefix_expl"]="Az a szöveg fog megelőzni bármely címet a böngésző fejlécében. Pl.: ajánlatos a szájt nevét beírni.";
$lll["seoProperties"]="Keresőmotor-optimalizáció";
$lll["settings_mainTitle"]="'Title' teg";
$lll["settings_mainTitle_expl"]="A TITLE, DESCRIPTION és KEYWORDS tegek tartalma többnyire attól függ, hogy melyik kategórialistán, vagy hírdetés adatlapon böngészünk éppen 
                                 - vagyis ezt kategóriánként meghatározhatja es a hírdetések tulajdonosai hírdetésenként is meghatározhatják. 
                                 Ez a három mező azonban az alapértelmezett értékeket tartalmazza azokra az oldalakra, melyek kívül esnek minden kategória- és hírdetés kontextuson (pl. maga a kezdőlap!)";
$lll["settings_mainDescription"]="'Description' meta teg";
$lll["settings_mainKeywords"]="'Keywords' meta teg";
$lll["settings_helpLink"]="A 'Segítség' hivatkozás címe";
$lll["settings_helpLink_expl"]="A Segítség oldalhoz vezető teljes URL. Ezzel meghatározhatja a saját szájtjának a 'segítség'-oldalát. E.g.: http://yoursite/classifieds_dir/customhelp.html";
$lll["settings_maxMediaSize"]="A feltölthető média-fájlok maximális mérete byte-ban";
$lll["settings_maxMediaSize_expl"]="'0' = nincs korlátozás.<br><br>Meg kell jegyezni azonban, hogy bármilyen értéket ad is meg itt, van két Php direktíva, amely lekorlátozza a feltolthető fájlok maximális méretét!. Ez az 'upload_max_filesize' és 'post_max_size'. 
                                    Vagy a 'php.ini' fájlban, vagy a 'httpd.conf'-ban, vagy a telepítési könyvtár '.htaccess' fájljában találhatók. Alapértelmezett értékük általában 2MB. 
                                    Megnövelheti értéküket mondjuk 50MB-ra a .htaccess fájlban a következő módon:<br><br>php_value upload_max_filesize \"50M\"<br>php_value post_max_size \"50M\" ";
// Changed in version 3.0.0. Old text:
//$lll["settings_subscriptionType"]="Auto notify";
// New text:
//$lll["settings_subscriptionType"]="Enable auto notify for";
$lll["settings_subscriptionType"]="Enable auto notify for";
$lll["settings_subscriptionType_expl"]="A felhasználók feliratkozhatnak automatikus értesítésekre, ha egy kategóriában új hírdetést adnak fel.
                                        <br><br>Az ingyenes verzió nem tartalmazza ezt a szolgáltatást!";
$lll["settings_subscriptionType_0"]="Az automatikus értesítések letiltása";
$lll["settings_subscriptionType_1"]="Engedélyezés csak regisztrált felhasználóknak";
$lll["settings_subscriptionType_2"]="Engedélyezés mindenkinek";
$lll["settings_menuPoints_expl"]="Ha a 'Hírdetés feladása' nincs bejelölve, csak admin láthatja a menüpontot (vagyis csak admin adhat fel hírdetést a szájton!). Úgy is letilthat vagy átrendezhet menüpontokat, hogy a 'menu_xyz.tpl.php' template fájlokat szerkeszti!";
$lll["settings_menuPoints"]="Menüpontok";
$lll["settings_menuPoints_2"]="Kijelentkezés";
$lll["settings_menuPoints_3"]="Belépés";
$lll["settings_menuPoints_4"]="Regisztráció";
$lll["settings_menuPoints_5"]="Profil";
$lll["settings_menuPoints_6"]="Hírdetéseim";
$lll["settings_menuPoints_7"]="Hírdetés feladása";
$lll["settings_menuPoints_8"]="Friss hírdetések";
$lll["settings_menuPoints_9"]="Legnépszerűbb hírdetések";
$lll["settings_menuPoints_10"]="Keresés";
$lll["settings_menuPoints_11"]="Kezdőlap";
$lll["settings_menuPoints_12"]="Segítség";
$lll["menuPointsSep"]="Menü személyreszabás";
$lll["expirationProperties"]="Hírdetéselévülési beállítások";
$lll["imageProperties"]="Képfeltöltési korlátozások";
$lll["otherProperties"]="Egyéb beállítások";
$lll["adDisplayProperties"]="Hírdetések megjelenítése";
$lll["settings_renewal"]="Ennyiszer hosszabbithatja meg az elévülő hírdetését egy felhasználó";
$lll["settings_allowModify"]="A felhasználó módosíthatja a hírdetését";
$lll["settings_extraHead"]="További HTML HEAD tartalom";
// Changed in version 4.1.0. Old text:
...
$lll["settings_extraBody"]="További HTML BODY tartalom";
// Changed in version 4.1.0. Old text:
...
$lll["settings_extraFooter"]="További lábléc tartalom";
// Changed in version 4.1.0. Old text:
...
$lll["customfield"]="Saját mező";
$lll["mustBeCommaSeparated"]="A kiválasztási lista típusú mezők lehetséges értékeit vesszővel elválasztott kifejezések formájában kell megadni";
$lll["invalidDefaultValue"]="Egy kiválasztási lista típusú mező alapértelmezett értéke a lehetséges értékekként meghatározott kifejezések egyike kell hogy legyen.";
$lll["description"]="Leírás";
$lll["descriptionDefaultLabel"]="Leírás";
$lll["privateField"]="Privát";
$lll["customfield_type_1"]="Szöveg";
$lll["customfield_type_2"]="Szövegdoboz";
$lll["customfield_type_3"]="Bekattintós bigyó (checkbox)";
$lll["customfield_type_4"]="Kiválasztási lista";
$lll["customfield_type_6"]="Többszörös kiválasztási lista";
$lll["customfield_type_5"]="Mezőelválasztó";
$lll["customfield_type_7"]="Bekattintós bigyók";
$lll["customfield_type_8"]="Kép";
$lll["customfield_type_10"]="Média fájl";
$lll["customfield_type_9"]="Web hivatkozás";
$lll["customfield_type_11"]="Dátum";
$lll["customfield_dateDefaultNow"]="A mai nap az alapértelmezett";
$lll["customfield_fromyear"]="A kiválasztás kezdőéve";
$lll["customfield_fromyear_expl"]="A dátum mező kitöltését segítő dátumszelektor ettől az évtől fog indulni.
                                   Beírhat egy konkrét évet mint pl. '1971', vagy beírhat 'now'-t, ami mindig az aktuális évet fogja jelenteni.
                                   Relatív évet is definiálhat a következpő módon: 'now-5' az jelenti, hogy a tartomány az öt évvel ezelőtti dátumtól indul!";
$lll["customfield_toyear"]="A kiválasztás záróéve";
$lll["customfield_toyear_expl"]="A dátum mező kitöltését segítő dátumszelektor eddig az évig fog tartani.
                                   Beírhat egy konkrét évet mint pl. '1971', vagy beírhat 'now'-t, ami mindig az aktuális évet fogja jelenteni.
                                   Relatív évet is definiálhat a következpő módon: 'now+5' az jelenti, hogy a tartomány az öt év múlva esedékes dátumig tart!";
$lll["customfield_name"]="Név";
$lll["customfield_type"]="Típus";
$lll["customfield_default_multiple"]="Alapértelmezett érték";
$lll["customfield_default_text"]="Alapértelmezett érték";
$lll["customfield_default_bool"]="Alapértelmezett érték";
$lll["customfield_active"]="Aktív";
$lll["customfield_separator"]="Oszlop %s";
$lll["customfield_mandatory"]="Kötelező kitölteni";
// Changed in version 3.0.0. Old text:
//$lll["customfield_showInList"]="Appears in list";
// New text:
//$lll["customfield_showInList"]="Show in lists for";
$lll["customfield_showInList"]="Show in lists for";
$lll["customfield_values"]="Lehetséges értékek";
$lll["customfield_innewline"]="Új sorban jelenik meg";
$lll["customfield_displaylength"]="Megjelenési hossz a listában";
$lll["customfield_displaylength_expl"]="A mező értékéből a hírdetéslistában megjelenített karakterek maximális száma. Ezzel védeni lehet a listát attól, hogy a túl hosszú cellák tönkretegyék a megjelenését.";
// Changed in version 3.1.0. Old text:
//$lll["customfield_searchable"]="Searchable";
// New text:
$lll["customfield_searchable"]="Show in the search form for";
$lll["customfield_rangeSearch"]="Tartománykeresés engedélyezése";
// Changed in version 3.1.0. Old text:
...
$lll["customfield_allowHtml"]="HTML engedélyezése";
...
$lll["customfield_subType"]="Ez a mező egy";
$lll["customfield_subType_1"]="Szöveg";
$lll["customfield_subType_2"]="Egész szám";
$lll["customfield_subType_3"]="Tizedes szám";
$lll["customfield_sortable"]="Rendezés engedélyezése a mező szerint";
$lll["customfield_expl"]="Magyarázó szöveg";
$lll["customfield_expl_expl"]="Mint pl. amit éppen most olvas! Az mező funkciójának részletesebb leírására lehet használni.";
$lll["private_field"]="(private)";
$lll["customfield_newitem"]="Új saját mező létrehozása";
$lll["customfield_modify_form"]="Saját mező módosítása";
$lll["customfield_create_form"]="Saját mező létrehozása";
$lll["customfield_sortId"]="Rendezés";
$lll["customfield_sorthelp"]="Használja a nyíl-ikonokat a 'Rendezés' oszlopban a sorrend módosítására, majd kattintson a 'Rendezés mentése' gombra alul!";
$lll["customfield_savesorting"]="Rendezés mentése";
$lll["customfield_sortingsaved"]="Az új mezőrendezést sikeresen elmentette.";
// Changed in version 3.0.0. Old text:
//$lll["customFields"]="List of custom fields of this category";
// New text:
//$lll["customFields"]="List of custom fields";
$lll["customFields"]="List of custom fields";
$lll["customfield_rowspan"]="Sorokon átnyúlik";
$lll["customfield_seo"]="Keresőmotor-optimalizáció";
$lll["customfield_seo_0"]="Nincs hozzárendelés";
// Changed in version 3.0.0. Old text:
...
$lll["customfield_mainPicture"]="Use this field as the main picture";
$lll["customfield_mainPicture_expl"]="Ez a kép típusú mező fog a nem kategória-specifikus listákban és RSS-feedekben szerepelni.";
// Changed in version 2.4.0. Old text:
...
$lll["customfield_seo_expl"]="You can specify here which custom field of the item will serve as the content of the HTML TITLE tag, DESCRIPTION tag and KEYWORDS tag, respectively. 
                              Besides SEO, the content of the TITLE fields will appear in the title bar of the browser when one 
                              displays the ad, it will be used as the title of the ad in non category specific ad lists and in RSS feeds.";
$lll["customfield_innewline_expl"]="Ahelyett, hogy egy új oszlopban jelenne meg a hírdetéslistában, ezzel a beteheti a mező értékét egy új sorba, ami a többi mező cellája alatt vizszintesen végignyúlik.";
// Changed in version 2.3.0. Old text:
...
$lll["customfield_rowspan_expl"]="Use this in conjunction with the 'Place in new line' property of other custom fields. If there are other fields which has been placed in a new line, you can specify with this setting that this field spans over those new lines vertically.";
$lll["notification"]="értesítő";
$lll["notification_ttitle"]="Értesítések";
$lll["Notifications"]="Értesítések";
$lll["notification_subject"]="Email tárgy";
$lll["notification_body"]="Email szöveg";
$lll["notification_variables"]="Engedélyezett változók";
$lll["notification_active"]="Aktív";
$lll["notification_modify_form"]="Értesítés módosítása";
...
$lll["notif_initpass_subj"]="Alapértelmezett jelszó";
$lll["notification_cc"]="CC";
$lll["notification_cc_expl"]="Carbon Copy.";
$lll["notification_active_expl"]="Az értesítők küldését kapcsolhatja ki/be itt.";
?>