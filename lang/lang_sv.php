...
$lll["user_name"]="Användarnamn";
$lll["user_ttitle"]="Användare";
$lll["user"]="Användare";
$lll["user_newitem"]="Lägg till ny användare";
$lll["email"]="Email";
$lll["user_lastClickTime"]="Last click";
$lll["user_passwordCopy"]="Repetera passord";
$lll["user_create_form"]="Registrera dig";
$lll["user_rememberPassword"]="Kom ihåg passord";
$lll["changePassword"]="Byt passord";
$lll["user_remind_password_form"]="Påminn mig om mitt passord";
$lll["remind_me_pw"]="Jag har glömt mitt passord, sänd mig ett mejl med ett nytt!";
$lll["remind_remind_password_form"]="Password reminder";
$lll["remindmail_subj"]="Passords påminnelse";
$lll["remindmail_text"]="Ditt användarnamn är: %s
Ditt passord är: %s
Tryck på följande länk för att aktivera passordet, försök sedan logga in:
%s

Vi rekommenderar att du byter ditt passord efter lyckad inloggning.";
$lll["remindmail_sent"]="Ett mejl är skickat till dig med ditt passord";
$lll["remind_username"]="Ditt användarnamn";
$lll["invalid_email"]="Fel mejladress! Det finns ingen användare med denna mejladress i systemet.";
$lll["mistypedPassword"]="Du har skrivit fel på ditt passord.";
$lll["passwordTooShort"]="Längden på ditt passord måste vara minst %s bokstäver.";
$lll["userAllreadyExists"]="Den angivna användaren finns redan.";
$lll["cannotAcceptCookie"]="Din läsare accepterar inga cookies, du kan inte registrera på egen hand.";
$lll["wellcomeNewlyRegistered"]="Ny användare %s har registrerats.";
$lll["greeting"]="Hej %s!";
$lll["loginInvalid"]="Det angivna användarnamnet eller passordet är felaktigt.";
$lll["never"]="Never";
$lll["user_login_form"]="Login";
$lll["user_modify_form"]="Ändra användar profil";
$lll["goodbye"]="Hej då %s";
$lll["user_change_password_form"]="Byt passord";
$lll["passwordModified"]="Ditt passord har blivit utbytt.";
$lll["timeoutExpired"]="Timeout. Var god, logga på igen!";
$lll["youWillGetAEmailCheckEmail"]="Din registrering är klar. Du får snart ett mejl med ditt initiala passord!.";
...
$lll["category_create_form"]="Skapa ny kategori";
$lll["category_newitem"]="Skapa ny kategori";
$lll["category_modify_form"]="Modifiera kategori";
$lll["subcats"]="Subcategories";
$lll["appcategory_allowAd"]="Tillåt annonser";
$lll["appcategory_picture"]="Bild";
$lll["appcategory_ttitle"]="Annons kategorier";
...
$lll["item_my_ttitle"]="Mina annonser";
$lll["item_cName"]="Category";
$lll["item_cid"]="Category";
$lll["item_clicked"]="Views";
$lll["item_id"]="ID";
$lll["item_responded"]="Svar";
$lll["item_expirationTime"]="Dagar kvar till borttagning";
...
$lll["new_resp"]="Svara på denna annons";
$lll["response_create_form"]="Svara på annons";
$lll["yourname"]="Ditt namn";
$lll["youremail"]="Din mejl";
$lll["friendsname"]="Din väns namn";
$lll["friendsemail"]="Din väns mejl";
$lll["response_mess"]="Ditt meddelande";
$lll["friendmail_mess"]="Ditt meddelande";
$lll["new_frie"]="Mejla detta till en vän";
...
$lll["advancedSearch"]="Kategori specifik avancerad sökning - sök efter annonser vars:";
$lll["search_relationBetweenFields_1"]="Samtliga ovanstående villkor";
$lll["search_relationBetweenFields_2"]="Några eller alla av ovanstående villkor";
$lll["search_create_form"]="Sök";
$lll["search_relationBetweenFields"]="Sök efter resultat som matchar";
$lll["search_cid"]="Kategori";
$lll["allCategories"]="Alla kategorier";
$lll["item_search_ttitle"]="Resultat av sökning";
$lll["contains"]=" innehåller";
$lll["is"]=" is";
...
$lll["search_str"]="Simple search";
$lll["search_autoNotify"]="Automatiskt meddelande";
$lll["clickHere"]="Tryck här";
$lll["saveSearch"]=" att spara dessa sök val för senare sökning!";
...
$lll["item_my"]="Mina annonser";
$lll["item_Active"]="Beviljade annonser";
$lll["item_Inctive"]="Väntande annonser";
$lll["item_recent"]="Nya annonser";
$lll["item_popular"]="Mest populära annonser";
$lll["merchants"]="Merchants";
$lll["category_new"]="Lägg till kategori";
$lll["category_del"]="Ta bort kategori";
$lll["category_mod"]="Modifiera kategori";
$lll["home"]="Hem";
$lll["my_profile"]="Min profil";
$lll["register"]="Registrera dig";
$lll["loginDifferrent"]="Login different";
$lll["login"]="Logga in";
$lll["logout"]="Logga ut";
$lll["help"]="Hjälp";
$lll["search"]="Sök";
$lll["adminsett"]="Inställningar";
$lll["users"]="Användare";
$lll["ok"]="Ok";
$lll["cancel"]="Avbryt";
$lll["back"]="Back";
...
$lll["permission_denied"]="Åtkomst nekad";
$lll["operation_cancelled"]="Operation avbruten";
$lll["create_completed"]="Den nya %s har blivit skapad.";
$lll["modify_completed"]="%s har blivit modifierad.";
$lll["delete_completed"]="%s har blivit borttagen.";
$lll["beforeDelete"]="Vill du verkligen ta bort den här %s'n?";
...
$lll["mandatoryField"]="'%s' är ett obligatoriskt fält";
...
$lll["icon_modify"]="ändra";
$lll["icon_delete"]="ta bort";
...
// New text:
$lll["creationtime"]="Created";
$lll["registerOrLoginToSubmit"]="Var god registrera dig själv eller logga in för att annonsera!";
$lll["loggedas"]="Du är inloggad som %s.";
$lll["logorreg"]="Var god registrera dig eller logga in.";
$lll["name"]="Namn";
$lll["emptylist"]="Listan är tom";
$lll["popuphelp_tit"]="Popup Hjälp";
