...
$lll["db_installed"]="%s duomenø bazë buvo instaliuota: %s";
// Changed in version 4.1.0. Old text:
...
$lll["inst_create_table_err"]="Klaida kuriant rëmelius, %s jau instaliuota?";
// Changed in version 4.1.0. Old text:
...
$lll["inst_click"]="Spauskite èia, kad prisijungtumëte prie %s.";
// Changed in version 4.1.0. Old text:
//$lll["createTableFailed"]="Create table failed";
// New text:
$lll["createTableFailed"]="Ouch! Create table failed";
$lll["install"]="Ádiegti";
$lll["clickToInstall"]="Paspauskite ant 'Ádiegti' mygtuko, kad ádiegtumëte %s!";
$lll["admin_ok"]="Vartotojas-administratorius buvo sukurtas, vartotojo vardas: admin, slaptaþodis: admin.";
// Changed in version 4.1.0. Old text:
...
$lll["inst_params"]="MySQL duomenø bazë bus sukurta pagal ðiuo duomenis:";
$lll["edit_params"]="Keisti duomenis";
...
$lll["mysqluser"]="Mysql vartotojos vardas";
$lll["dbName"]="Database name";
$lll["dbDbName"]="Duomenø bazës pavadinimas";
$lll["dbSocket"]="Socket";
$lll["formtitle"]="MySQL nustatymai";
$lll["password"]="Slaptaþodis";
$lll["dbPort"]="Port";
$lll["cookieok"]="Cookies veikia.";
// Changed in version 4.1.0. Old text:
...
$lll["afterwrconf"]="<u>Po to kai</u> sukursire app/config.php failà ir patalpinsite já á reikiamà direktorija, paspauskite þemiau esanèià nuorodà!";
$lll["move_inst_file"]="Praðome paðalinti install.php ið direktorijos!";
// Changed in version 4.1.0. Old text:
...
$lll["create_file_nok_ext"]="Serveriui yra draudþiama sukurti config failà. Jûs turite dvi iðeitis:<br>\Nr. 1: Pagrindinëje kategorijoje patys sukurkite tuðèià failà app/config.php ir suteikite serveriui raðymo á ðá failà leidimà. Unix sistemoje:<br>paþymëkite app/config.php failà ir nustatykite chmod 777p<br>Nr. 2: Paspauskite ant install mygtuko ir sukurkite config failà patys.<br>Programa jums parodys kà reikia áterpri á ðá app/config.php failà.";
...
$lll["settings"]="Nustatymai";
$lll["settings_modify_form"]="Personalizacija";
$lll["settings_expNoticeBefore"]="Dienø skaièius kai vartotojas turi bûti informuojamas apie skelbimo pasibaigimo laikà";
$lll["settings_charLimit"]="Leidþiamø simboliø skaièius vienam skelbimui";
$lll["settings_blockSize"]="Puslapyje rodomø skelbimø skaièius";
$lll["settings_maxPicSize"]="Didþiausias leidþiamas paveiksliuko dydis baitais";
$lll["settings_maxPicWidth"]="Didþiausias leidþiamas paveiksliuko plotis taðkais";
$lll["settings_maxPicHeight"]="Didþiausias leidþiamas paveiksliuko aukðtis taðkais";
...
$lll["customfield"]="Kintamøjø reikðmiø laukai";
$lll["mustBeCommaSeparated"]="Galimos nustatymø laukø reikðmës turi bûti atskiriamos kableliais.";
$lll["invalidDefaultValue"]="Nustatymo laukø reikðmës pagal nutylëjimà, turi bûti bent viena kableliu atskirta reikðmë, ávesta á galimø reikðmiø nurodymo laukelá.";
$lll["description"]="Description";
$lll["descriptionDefaultLabel"]="Apibûdinimas";
$lll["privateField"]="Privatu";
$lll["customfield_type_1"]="Tekstas";
$lll["customfield_type_2"]="Teksto laukas";
$lll["customfield_type_3"]="Boolean'as";
$lll["customfield_type_4"]="Þymëjimas";
$lll["customfield_type_6"]="Multiple tymëjimas";
$lll["customfield_type_5"]="Skyrimas";
...
$lll["customfield_name"]="Vardas";
$lll["customfield_type"]="Tipas";
...
$lll["customfield_active"]="Aktyvus";
$lll["customfield_separator"]="Stulpelis 1.";
$lll["customfield_mandatory"]="Privaloma";
// Changed in version 3.0.0. Old text:
//$lll["customfield_showInList"]="Appears in list";
// New text:
//$lll["customfield_showInList"]="Show in lists for";
$lll["customfield_showInList"]="Show in lists for";
$lll["customfield_values"]="Galimos reikðmës";
$lll["customfield_innewline"]="Patalpinti naujoje eilutëje";
...
$lll["customfield_allowHtml"]="Leisti naudoti HTML";
...
$lll["customfield_private"]="Leisti vartotojams paslëpti asmeninæ informacijà";
...
$lll["customfield_modify_form"]="Nustatyti kintamøjø reikðmes ðios kategorijos skelbimams";
...
$lll["customfield_rowspan_expl"]="Use this in conjunction with the 'Place in new line' property of other custom fields. If there are other fields which has been placed in a new line, you can specify with this setting that this field spans over those new lines vertically.";
$lll["notification"]="praneðimas";
$lll["notification_ttitle"]="Praneðimai";
$lll["Notifications"]="Praneðimai";
$lll["notification_subject"]="Emailo antraðtë";
$lll["notification_body"]="Emailo body dalis";
$lll["notification_variables"]="Leidþiami kintamieji";
$lll["notification_active"]="Aktyvus";
$lll["notification_modify_form"]="Modifikuoti praneðimà";
...
$lll["notification_cc_expl"]="Nurodykite emailà, kuriuo turëtø bûti iðsiøsta kopija.";
$lll["notification_active_expl"]="Èia jûs galite ájungti ir iðjungti praneðimo siuntimo funklcijà.";
?>