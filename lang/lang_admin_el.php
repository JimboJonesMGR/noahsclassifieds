...
$lll["db_installed"]="%s βάση δεδομένων έχει εγκατασταθεί: %s";
// Changed in version 4.1.0. Old text:
...
$lll["inst_create_table_err"]="Λάθος κατα την προσπάθεια δημιουργίας των πινάκων της Βάσης Δεδομένων, %s μήπως είναι ήδη εγκατεστημένοι";
// Changed in version 4.1.0. Old text:
...
$lll["inst_click"]="Πατήστε εδώ για πρόσβαση %s.";
// Changed in version 4.1.0. Old text:
//$lll["createTableFailed"]="Create table failed";
// New text:
$lll["createTableFailed"]="Ouch! Create table failed";
$lll["install"]="Install";
$lll["clickToInstall"]="Πατήστε στο 'Install' για εγκατάσταση %s!";
$lll["admin_ok"]="Ο λογαριασμός Διαχειρηστή δημιουργήθηκε, Ονομα χρήστη: admin, Κωδικός εισόδου: admin.";
// Changed in version 4.1.0. Old text:
...
$lll["inst_params"]="MySQL Βασή θα δημιουργηθεί με τις ακόλουθες παραμέτρους:";
$lll["edit_params"]="Διόρθωση παραμέτρων";
...
$lll["hostName"]="Hostname (Τοποθεσία Βάσης) ";
$lll["dbHostName"]="Τοποθεσία Βάσης (ΟΝΟΜΑ) (Hostname)";
$lll["mysqluser"]="Mysql όνομα χρήστη (username) ";
$lll["dbName"]=" Ονομα Βάσης (Database name)";
$lll["dbDbName"]="Ονομα βάσεως (Database name)";
$lll["dbSocket"]="Socket (Υποδοχή)";
$lll["formtitle"]="MySQL Ρυθμίσεις(Settings)";
$lll["password"]="Κωδικός";
$lll["dbPort"]="Θύρα - Port";
$lll["cookieok"]="Cookies είναι ενεργοποιημένα.";
// Changed in version 4.1.0. Old text:
...
$lll["afterwrconf"]="<u>Μετά</u> μεταγρλαψτε το αρχείο στον επάνω δεσμό!";
$lll["move_inst_file"]="Παρακαλούμε αφαιρέστε το αρχείο install.php απο αυτό ττον κατάλογο!";
// Changed in version 4.1.0. Old text:
...
$lll["create_file_nok_ext"]="Ο server δεν έχει καμία δικαιοδοσία να δημιουργήσει το αρχείο config. Έχετε δύο επιλογές:<br>
#1: Δημιουργήστε ένα κενό αρχείο στον κατάλογο αρχείων εφαρμογής με το όνομα app/config.php, και δώστε στον server  τη δικαιοδοσία σε αυτό. Κάτω από unix:<br>touch app/config.php;chmod 777 app/config.php<br>και πατήστε το κουμπί Reload/Refresh.<br>#2: Πατήστε στο install και δημιουργείστε το αρχείο config χειροκίνητα με το αγαπημένο σας επεξεργαστή κειμένου.<br>Το πρόγραμμα θα εμφανίσει το κείμενο που πρέπει να γράψετε στο αρχείο app/config.php.";
...
$lll["u_maintitle"]="Διαδικασία αναπροσαρμογών";
// Changed in version 4.1.0. Old text:
...
$lll["ready_to_update"]="Αναμείνετε για να γίνει ενημέρωση της βάσης δεδομένων %s στην έκδοση %s;<br>";
// Changed in version 4.1.0. Old text:
...
$lll["updating"]="Ενημέρωση από την έκδοση %s στην έκδοση %s... ";
// Changed in version 4.1.0. Old text:
...
$lll["settings_adminEmail"]="E-mail Διαχειριστή";
// Changed in version 4.1.0. Old text:
...
$lll["settings"]="Ρυθμίσεις";
$lll["settings_modify_form"]="Προσωποποιήστε";
$lll["settings_expNoticeBefore"]="Ο αριθμός ημερών που ο χρήστης πρέπει να ενημερωθεί για τη λήξη ";
$lll["settings_charLimit"]="Ο αριθμός χαρακτήρων που μπορεί να έχει μια αγγελία ";
$lll["settings_blockSize"]="Αγγελίες που εμφανίζονται ανά σελίδα ";
$lll["settings_maxPicSize"]="Μέγιστο μέγεθος εικόνων σε bytes";
$lll["settings_maxPicWidth"]="Μέγιστο πλάτος εικόνων σε pixels";
$lll["settings_maxPicHeight"]="Μέγιστο ύψος εικόνων σε pixels";
...
$lll["menuPointsSep"]="Παραμετροποίηση Μενού";
$lll["expirationProperties"]="Ιδιότητες Λήξης";
$lll["imageProperties"]="Περιορισμοί ανεβάσματος εικόνων";
$lll["otherProperties"]="’λλες ρυθμίσεις";
$lll["adDisplayProperties"]="Ad display settings";
$lll["settings_renewal"]="Οι φορές που ο χρήστης επιτρέπεται να παρατείνει τις ληγμένες αγγελίες του/της ";
$lll["settings_allowModify"]="Ο χρήστης έχει την άδεια για να τροποποιήσει τις αγγελίες του/της";
...
$lll["customfield"]="Μεταβλητά πεδία";
$lll["mustBeCommaSeparated"]="Οι πιθανές τιμές των  πεδίων τύπων επιλογής πρέπει να οριστούν ως συμβολοσειρές χωρισμένες με κόμμα ";
$lll["invalidDefaultValue"]="Η προκαθορισμένη τιμή ενός πεδίου τύπων επιλογής πρέπει να είναι μία από τις συμβολοσειρές χωρισμένες με  κόμμα που εμφανίζονται  στην λίστα  πιθανων πεδίων τιμών.";
$lll["description"]="Description";
$lll["descriptionDefaultLabel"]="Περιγραφή";
$lll["privateField"]="Προσωπικό";
$lll["customfield_type_1"]="Κείμενο";
$lll["customfield_type_2"]="Πεδίο κειμένου";
$lll["customfield_type_3"]="Λογικές τιμές 1 ή 0";
$lll["customfield_type_4"]="Επιλογή";
$lll["customfield_type_6"]="Πολλαπλή επιλογή";
$lll["customfield_type_5"]="Διαχωριστικό";
...
$lll["customfield_name"]="Όνομα";
$lll["customfield_type"]="Τύπος";
...
$lll["customfield_active"]="Ενεργό";
$lll["customfield_separator"]="Στήλη 1.";
$lll["customfield_mandatory"]="Υποχρεωτικό";
// Changed in version 3.0.0. Old text:
//$lll["customfield_showInList"]="Appears in list";
// New text:
//$lll["customfield_showInList"]="Show in lists for";
$lll["customfield_showInList"]="Show in lists for";
$lll["customfield_values"]="Πιθανές τιμές";
$lll["customfield_innewline"]="Τοποθέτηση σε νέα γραμμή ";
...
$lll["customfield_allowHtml"]="Επιτρέπετε HTML";
...
$lll["customfield_private"]="Επιτρέπονται ιδιωτικά πεδία";
...
$lll["private_field"]="(Προσωπικό)";
$lll["customfield_newitem"]="Add new custom field";
$lll["customfield_modify_form"]="Καθορισμός μεταβλητών πεδίων αγγελιών για αυτή την κατηγορία";
...
$lll["customfield_rowspan_expl"]="Use this in conjunction with the 'Place in new line' property of other custom fields. If there are other fields which has been placed in a new line, you can specify with this setting that this field spans over those new lines vertically.";
$lll["notification"]="Ανακοίνωση -";
$lll["notification_ttitle"]="Ανακοινώσεις";
$lll["Notifications"]="Ανακοινώσεις";
$lll["notification_subject"]="Θέμα Email";
$lll["notification_body"]="Κυρίως σώμα Email";
$lll["notification_variables"]="Επιτρεπόμενες μεταβλητές";
$lll["notification_active"]="Ενεργό";
$lll["notification_modify_form"]="Τροποποίηση ανακοίνωσης";
$lll["notif_remindpass_tit"]="Contains a new password if the user forgot the old one.";
$lll["notif_remindpass_subj"]="New password";
$lll["notif_initpass_tit"]="Αποστέλνεται στον χρήστη μετά την εγγραφή, περιέχει τον αρχικό κωδικό προσβασής";
$lll["notif_initpass_subj"]="Αρχικός κωδικός πρόσβασης";
$lll["notification_cc"]="Κοιν.";
$lll["notification_cc_expl"]="Προσδιορίστε εδώ το e-mail που  πρέπει να σταλεί η ανακοίνωση ως αντίγραφο.";
$lll["notification_active_expl"]="Μπορείτε να ενεργοποιήσετε ή όχι την αποστολή αυτής της ανακοίνωσης εδώ";
?>