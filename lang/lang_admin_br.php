...
$lll["db_installed"]="A base de dados %s foi instalada: %s";
// Changed in version 4.1.0. Old text:
...
$lll["inst_create_table_err"]="Erro ao criar as tabelas, %s já está instalada?";
// Changed in version 4.1.0. Old text:
...
$lll["inst_click"]="Clique aqui para aceder %s.";
// Changed in version 4.1.0. Old text:
//$lll["createTableFailed"]="Create table failed";
// New text:
$lll["createTableFailed"]="Ouch! Create table failed";
$lll["install"]="Instalar";
$lll["clickToInstall"]="Clique em 'Instalar' para instalar %s!";
$lll["admin_ok"]="Administrador criado com sucesso, nome de utilizador: admin, senha: admin.";
// Changed in version 4.1.0. Old text:
...
$lll["inst_params"]="A base de dados MySQL será criada com os seguintes parâmetros:";
$lll["edit_params"]="Editar parâmetros";
...
$lll["dbHostName"]=$lll["hostName"]="Servidor";
$lll["mysqluser"]="Nome de utilizador Mysql";
$lll["dbDbName"]=$lll["dbName"]="Nome da base de dados";
$lll["dbSocket"]="Socket";
$lll["formtitle"]="Definições MySQL";
$lll["password"]="senha";
$lll["dbPort"]="Porto";
$lll["cookieok"]="Cookies activados.";
// Changed in version 4.1.0. Old text:
...
$lll["afterwrconf"]="<u>Depois de</u> gravar o ficheiro de configuração clique no link seguinte!";
$lll["move_inst_file"]="Por favor remova o ficheiro install.php do direcótirio!";
// Changed in version 4.1.0. Old text:
...
$lll["create_file_nok_ext"]="O servidor não tem permissões para criar o ficheiro de configuração. Tem duas opções:<br>
#1: Criar um ficheiro vazio no directório da aplicação com o nome app/config.php, e atribuir-lhe permissões de escrita. Em unix:<br>touch app/config.php;chmod 777 app/config.php<br>e clicar no botão de Reload/Refresh do browser.<br>#2: Clique em instalar e crie o ficheiro de configuração manualmente com o seu editor de texto.<br>O programa mostra o texto a incluir no ficheiro app/config.php.";
// register:
...
$lll["u_maintitle"]="Em processo de actualização";
// Changed in version 4.1.0. Old text:
...
$lll["nopermission_expl"]="(Noah's Classifieds tries to save the advertisement pictures under 'pictures/ads' and the category pics under 'pictures/cats'. You have to make sure the program has enough permission to do this.)";
...
$lll["settings_adminEmail"]="Email do sistema";
// Changed in version 4.1.0. Old text:
...
//globalsettings
$lll["settings"]="Definições";
$lll["settings_modify_form"]="Personalizar";
$lll["settings_expNoticeBefore"]="Número de días antes de ser retirado em que o utilizador seré informado";
$lll["settings_charLimit"]="Número de caracteres que um anúncio pode conter";
$lll["settings_charLimit_expl"]="'0' means no limit.";
$lll["settings_blockSize"]="Anúncios apresentados por página";
$lll["settings_maxPicSize"]="Tamanho máximo da imagem em bytes";
$lll["settings_maxPicWidth"]="Largura máxima da imagem em pixels";
$lll["settings_maxPicHeight"]="Altura máxima da imagem em pixels";
...
$lll["settings_subscriptionType"]="Enable auto notify for";
$lll["settings_subscriptionType_expl"]="Users can subscribe for getting automatic notifications if new ads are submitted in a category.<br><br>This feature is not available in the Evaluation version!";
...
$lll["menuPointsSep"]="Menu definições";
$lll["expirationProperties"]="Propriedades do Término";
$lll["imageProperties"]="Limitações de envio de imagens";
$lll["otherProperties"]="Outras definições";
$lll["adDisplayProperties"]="Ad display settings";
$lll["settings_renewal"]="Número de vezes que o utilizador pode prolongar o anúncio";
$lll["settings_allowModify"]="Utilizador pode modificar os seus anúncios";
...
$lll["settings_showEmail_".customfield_forNone]="none";
$lll["settings_showEmail_".customfield_forAll]="all";
$lll["settings_showEmail_".customfield_forLoggedin]="logged in users only";
$lll["settings_showEmail_".customfield_forAdmin]="admin only";
// Custom Fields
$lll["customfield"]="Campos variaveis";
$lll["mustBeCommaSeparated"]="Os valores possiveis dos campos de tipo selecção devem definir-se mediante palavras separadas por virgulas";
$lll["invalidDefaultValue"]="O valor por defeito de um campo tipo selecção deve ser uma das palavras separadas por virgilas listadas no campo dos valores possiveis.";
$lll["descriptionDefaultLabel"]=$lll["description"]="Descrição";
$lll["privateField"]="Privado";
$lll["customfield_type"."_".customfield_text]="Texto";
$lll["customfield_type"."_".customfield_textarea]="Área de texto";
$lll["customfield_type"."_".customfield_bool]="Booleano";
$lll["customfield_type"."_".customfield_selection]="Seleção";
$lll["customfield_type"."_".customfield_multipleselection]="Seleção múltipla";
$lll["customfield_type"."_".customfield_separator]="Separador";
$lll["customfield_type"."_".customfield_checkbox]="Checkbox";
$lll["customfield_type"."_".customfield_picture]="Imagem";
...
$lll["customfield_name"]="Nome";
$lll["customfield_type"]="Tipo";
$lll["customfield_type"."_expl"]="Note: To avoid type conflicts, if you have ever set this column to active and there are already items in this category, you can't change the type any more. If you insist on changing the type anyway, you have to remove all items from the category first.";
...
$lll["customfield_separator"]="Coluna 1.";
$lll["customfield_mandatory"]="Obrigatorio";
// Changed in version 3.0.0. Old text:
...
$lll["customfield_innewline"]="Colocar nuna nova linha";
...
$lll["customfield_searchable"."expl"]="If checked, users can search by this attribute using a range of numbers like '10-20'";
...
$lll["customfield_private"]="Permitir conservar privado";
...
$lll["customfield_modify_form"]="Estabelecer os campos variaveis dos anúncios nesta categoria";
...
$lll["customfield_seo_".customfield_title]="Use this field as the TITLE of the ad";
$lll["customfield_seo_".customfield_description]="Use this field as the DESCRIPTION of the ad";
$lll["customfield_seo_".customfield_keywords]="Use this field as the KEYWORDS of the ad";
// Changed in version 3.0.0. Old text:
...
$lll["customfield_showInDetails_".customfield_forNone]="none";
$lll["customfield_showInDetails_".customfield_forAll]="all";
$lll["customfield_showInDetails_".customfield_forLoggedin]="logged in users only";
$lll["customfield_showInDetails_".customfield_forOwner]="owner of the ad only";
$lll["customfield_showInDetails_".customfield_forAdmin]="admin only";
...
// Notifications:
$lll["notification"]="notificação";
$lll["Notifications"]=$lll["notification_ttitle"]="Notificações";
$lll["notification_subject"]="Assunto de email";
$lll["notification_body"]="Corpo de mail";
$lll["notification_variables"]="Variáveis autorizadas";
$lll["notification_active"]="Activa";
$lll["notification_modify_form"]="Modificar notificação";
...
$lll["notification_cc_expl"]="Especifique aqui o endereço para onde deve ser enviada uma cópia (CC) da notificação.";
$lll["notification_active_expl"]="Pode permutar entre o envio ou não desta notificação.";
//Category:
...
$lll["category_organize"]="Organizar categorias";
$lll["exp"]="Expiração";
