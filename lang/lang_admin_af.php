...
$lll["db_installed"]="%s databasis was geïnstalleer: %s";
// Changed in version 4.1.0. Old text:
...
$lll["inst_create_table_err"]="'n Fout is ondervind terwyl daar besig was om te probeer tabelle skep, %s alreeds geïnstalleer?";
// Changed in version 4.1.0. Old text:
...
$lll["inst_click"]="Kliek hier om toegang te kry tot %s.";
// Changed in version 4.1.0. Old text:
//$lll["createTableFailed"]="Create table failed";
// New text:
$lll["createTableFailed"]="Ouch! Create table failed";
$lll["install"]="Installeer";
$lll["clickToInstall"]="Kliek op 'Installeer' om %s te installeer!";
$lll["admin_ok"]="Administreur gebruiker was geskep, gebruikersnaam: administrasie, wagwoord: administrasie.";
// Changed in version 4.1.0. Old text:
...
$lll["inst_params"]="MySQL databasis sal met die volgende parameters geskep word:";
$lll["edit_params"]="Redigeer parameters";
...
$lll["hostName"]="Gasheernaam";
$lll["dbHostName"]="Gasheernaam";
$lll["mysqluser"]="Mysql gebruikersnaam";
$lll["dbName"]="Databasis naam";
$lll["dbDbName"]="Databasis naam";
$lll["dbSocket"]="Sok";
$lll["formtitle"]="MySQL Instellings";
$lll["password"]="Wagwoord";
$lll["dbPort"]="Poort";
$lll["cookieok"]="Koekies is ontsper.";
// Changed in version 4.1.0. Old text:
...
$lll["afterwrconf"]="<u>Nadat</u> die config lêer geskryf is, kliek op die onderstaande skakel!";
$lll["move_inst_file"]="Verwyder asseblief die install.php lêer van hierdie gids!";
// Changed in version 4.1.0. Old text:
...
$lll["create_file_nok_ext"]="Die bediener het geen permissie om die config lêer te skep nie. Jy het twee keuses:<br>
#1: Skep 'n lee lêer in die applikasie gids met die naam app/config.php, en gee die bediener permissie om daarnatoe te skryf. Onder unix:<br>kliek op app/config.php;chmod 777 die app/config.php lêer<br>en kliek op die Reload/Refresh knoppie.<br>#2: Jy kliek op install en skep self die config lêer in jou gekose teks redigeerder.<br>Die program sal jou die teks wat jy na die app/config.php lêer toe moet skryf, wys.";
...
$lll["u_maintitle"]="Noah's Classifieds opdateer proses";
// Changed in version 4.1.0. Old text:
...
$lll["ready_to_update"]="Gereed om databasis %s op te dateer na weergawe %s?<br>";
// Changed in version 4.1.0. Old text:
...
$lll["updating"]="opdatering van weergawe %s na weergawe %s...";
// Changed in version 4.1.0. Old text:
...
$lll["nopermission_expl"]="(Noah's Classifieds probeer om die advertensie grafieka onder 'pictures/listings' en die kategorie grafieka onder 'pictures/cats' te stoor. Jy moet seker maak dat die program genoegsaam permissie het om dit te doen.)";
...
$lll["here1"]="Kliek hier";
$lll["confpreerr"]="Daar is sekere karakters voor die &lt;? in die config lêer! Skrap asseblief hierdie karakters (nuwe lyne en spasies ook)!";
$lll["confposterr"]="Daar is sekere karakters agter die ?&gt; in die config lêer! Skrap asseblief hierdie karakters (nuwe lyne en spasies ook)!";
$lll["conffileok"]="Die lyk of die config lêer reg is.";
// Changed in version 4.1.0. Old text:
...
$lll["confcheck"]="Sisteem konfigurasie toets...";
// Changed in version 4.1.0. Old text:
...
$lll["confclicheck"]="Jy kan ten eniger tyd toegang tot hierdie konfigurasie toets bladsy verkry deur op die 'Toets' skakel op die hoof kieslysbalk te kliek.";
$lll["chadmemail"]="Jou bestaande e-pos adres is admin@admin.admin. Korrigeer dit asseblief deur op die 'My profiel' skakel op die hoof kieslysbalk te kliek!";
// Changed in version 4.1.0. Old text:
...
$lll["chadmpass"]="Die verstek administrasie wagwoord in nog nie verander nie! Verander dit asseblief deur op die 'Verander wagwoord' skakel op die hoof kieslysbalk te kliek!";
$lll["settings_adminEmail"]="Sisteem e-pos";
// Changed in version 4.1.0. Old text:
...
$lll["nogd"]="Waarskuwing: jou bediener het nie 'n geïnstalleerde GD biblioteek nie.";
// Changed in version 4.1.0. Old text:
...
$lll["settings"]="Instellings";
$lll["settings_modify_form"]="Verpersoonliking";
$lll["settings_expNoticeBefore"]="Aantal dae wat 'n gebruiker ingelig moet voordat die vervaltyd aanbreek";
$lll["settings_charLimit"]="Aantal karakters wat 'n plasing mag hê";
$lll["settings_blockSize"]="Advertensies vertoon per bladsy";
$lll["settings_maxPicSize"]="Maksimum grafieka grootte in grepe";
$lll["settings_maxPicWidth"]="Maksimum grafieka breedte in pixels";
$lll["settings_maxPicHeight"]="Maksimum grafieka hoogte in pixels";
...
$lll["menuPointsSep"]="Kieslys pasmakings";
$lll["expirationProperties"]="Vervaltyd eienskappe";
$lll["imageProperties"]="Grafieka oplaai limitasies";
$lll["otherProperties"]="Ander instellings";
$lll["adDisplayProperties"]="Ad display settings";
$lll["settings_renewal"]="Aantal kere wat 'n gebruiker geregtig is om sy/haar vervalde advertensies te verleng";
$lll["settings_allowModify"]="Gebruiker is toegelaat om sy/haar advertensie te verander";
...
$lll["customfield"]="Variabele velde";
$lll["mustBeCommaSeparated"]="Die moontlike waardes van die seleksie tipe velde moet as komma geskeide stringe omskryf word";
$lll["invalidDefaultValue"]="Die verstek waarde van die seleksie tipe velde moet een van die komma geskeide stringe, gelys in die moontlike waardes veld wees.";
$lll["description"]="Description";
$lll["descriptionDefaultLabel"]="Beskrywing";
$lll["privateField"]="Privaat";
$lll["customfield_type_1"]="Teks";
$lll["customfield_type_2"]="Teksarea";
$lll["customfield_type_3"]="Boolean";
$lll["customfield_type_4"]="Seleksie";
$lll["customfield_type_6"]="Meervoudige seleksie";
$lll["customfield_type_5"]="Skeier";
$lll["customfield_type_7"]="Merkblokkie";
...
$lll["customfield_active"]="Aktief";
$lll["customfield_separator"]="Kolom 1.";
$lll["customfield_mandatory"]="Verpligtend";
// Changed in version 3.0.0. Old text:
//$lll["customfield_showInList"]="Appears in list";
// New text:
//$lll["customfield_showInList"]="Show in lists for";
$lll["customfield_showInList"]="Show in lists for";
$lll["customfield_values"]="Moontlike waardes";
$lll["customfield_innewline"]="Plaas in nuwe lyn";
...
$lll["customfield_allowHtml"]="Laat HTML toe";
...
$lll["customfield_private"]="Laat om privaat te hou toe";
...
$lll["private_field"]="(privaat)";
$lll["customfield_newitem"]="Add new custom field";
$lll["customfield_modify_form"]="Stel die variabele velde of advertensies vir hierdie kategorie";
...
$lll["customfield_rowspan_expl"]="Use this in conjunction with the 'Place in new line' property of other custom fields. If there are other fields which has been placed in a new line, you can specify with this setting that this field spans over those new lines vertically.";
$lll["notification"]="notifikasie";
$lll["notification_ttitle"]="Notifikasies";
$lll["Notifications"]="Notifikasies";
$lll["notification_subject"]="E-pos onderwerp";
$lll["notification_body"]="E-pos liggaam";
$lll["notification_variables"]="Laat variabele toe";
$lll["notification_active"]="Aktief";
$lll["notification_modify_form"]="Verander notifikasie";
$lll["notif_remindpass_tit"]="Contains a new password if the user forgot the old one.";
$lll["notif_remindpass_subj"]="New password";
$lll["notif_initpass_tit"]="Stuur na die gebruiker na die registrasie, bevat die aanvanklike wagwoord";
$lll["notif_initpass_subj"]="Aanvanklike wagwoord";
$lll["notification_cc"]="KK";
$lll["notification_cc_expl"]="Spesifiseer die e-pos adres hier waarheen die notifikasie as 'n koolkopie gestuur moet word.";
$lll["notification_active_expl"]="Jy kan die stuur van hierdie notifikasie hier aan en af skakel.";
?>