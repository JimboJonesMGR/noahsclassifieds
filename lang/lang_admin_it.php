...
$lll["db_installed"]="Il database %s è stato installato: %s";
// Changed in version 4.1.0. Old text:
...
$lll["inst_create_table_err"]="Errore nella creazione delle tabelle, %s già installato?";
// Changed in version 4.1.0. Old text:
...
$lll["admin_ok"]="L'utente 'Amministratore' è stato creato, username: admin, password: admin.";
// Changed in version 4.1.0. Old text:
...
$lll["customfield_type_4"]="Seleziona";
$lll["customfield_type_6"]="Seleziona Multipla";
$lll["customfield_type_5"]="Separatore";
...
$lll["customfield_active"]="Attivo";
$lll["customfield_separator"]="Colonna 1.";
$lll["customfield_mandatory"]="Obbligatorio";
// Changed in version 3.0.0. Old text:
//$lll["customfield_showInList"]="Appears in list";
// New text:
//$lll["customfield_showInList"]="Show in lists for";
$lll["customfield_showInList"]="Show in lists for";
$lll["customfield_values"]="Valori Possibili";
$lll["customfield_innewline"]="Inserisci in una nuova linea";
...
$lll["customfield_allowHtml"]="Consenti HTML";
...
$lll["customfield_private"]="Consenti Annuncio Privato";
...
$lll["customfield_modify_form"]="Definisci le variabili per gli annunci di questa categoria";
...
$lll["customfield_rowspan_expl"]="Use this in conjunction with the 'Place in new line' property of other custom fields. If there are other fields which has been placed in a new line, you can specify with this setting that this field spans over those new lines vertically.";
$lll['notification']='Notifiche';
$lll['notification_ttitle']='Notifiche';
$lll['Notifications']='Notifiche';
$lll['notification_subject']='Oggetto dell\'e-mail';
$lll['notification_body']='Contenuto dell\'e-mail';
$lll['notification_variables']='Variabili accettate';
$lll['notification_active']='Attivo';
$lll['notification_modify_form']='Modifica notifica';
$lll['notif_remindpass_tit']='Contiene una nuova password nel caso l\'utente abbia dimenticato la vecchia password.';
$lll['notif_remindpass_subj']='Nuova password';
$lll['notif_initpass_tit']='Contiene la password iniziale inviata all\'utente dopo la registrazione';
$lll['notif_initpass_subj']='Password iniziale';
$lll['notification_cc']='CC';
$lll['notification_cc_expl']='Indica qui l\'indirizzo e-mail cui la notifica deve essere inviata in CC.';
$lll['notification_active_expl']='Qui puoi attivare o disattivare l\'invio delle notifiche.';
?>