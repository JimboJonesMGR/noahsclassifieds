            ...
            <table>
              <tr>
                <?php if( $this->get("flaggedLink") ): ?>
                  <td style='padding-right: 10px; text-align: right;'><div class='friend'><?php echo $this->get("flaggedLink") ?></div></td>
                <?php endif; ?>  
                <?php if( $this->get("responseLink") ): ?>
                  <td style='padding-left: 10px; padding-right: 10px; text-align: center;'><div class='friend'><?php echo $this->get("responseLink") ?></div></td>
                <?php endif; ?>
                <?php if( $this->get("friendmailLink") ): ?>
                  <td style='padding-left: 10px; text-align: left;'><div class='friend'><?php echo $this->get("friendmailLink") ?></div></td>
                <?php endif; ?>  
              </tr>  
            </table>
          </td>  
